...
$userId = $_GET['userId'];
$_naslovStranice = 'Edit user ' . $userId;
$_opisStranice = '';
$_kredit = 0;
include_once '../header.php';

$query = "SELECT ime, prezime, username, email, password, gradMjesto, datumRodjenja FROM users WHERE id = ?";
...
echo '<h1>Edit User <a class="btn btn-primary" href="index.php">Natrag na popis</a></h1>'; 
